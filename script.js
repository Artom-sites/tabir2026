    ...
    ua: {
        ...
        program: {
            ...
            day1: {
                ...
                event1: '17:00 — Заїзд та заселення',
                event2: '18:00 — Спільна вечеря',
                event3: '19:00 — Програма табору, бесіда, розкриття теми',
                event4: '21:00 — Спілкування: чай, ігри, вікторини',
                note: 'Перший вечір 🤝'
            },
            day2: {
                title: 'Вівторок, 10 лютого',
                event1: '08:00–09:00 — Сніданок',
                event2: '09:00–10:00 — Ранкове зібрання',
                event3: '10:00–13:00 — Дозвілля',
                event4: '13:00–14:00 — Обід',
                event5: '14:00–18:00 — Дозвілля',
                event6: '18:00–19:00 — Вечеря',
                event7: '19:00–20:00 — Загальне зібрання',
                event8: '21:00 — Спілкування, ігри, вікторини',
                note: 'Повний день ⛷️'
            },
            day3: {
                ...
                event7: '19:00–20:00 — Загальне зібрання',
                event8: '21:00 — Спілкування, ігри, вікторини',
                note: 'День спілкування ❤️'
            },
            day4: {
                title: 'Четвер, 12 лютого',
                event1: '08:00–09:00 — Сніданок',
                event2: '09:00–11:00 — Ранкове зібрання, підсумки',
                event3: '11:00–12:30 — Збір речей',
                event4: '13:00–14:00 — Обід',
                event5: '14:00 — Виїзд з табору',
                event6: 'Після виїзду — Катання на ковзанах 🛼',
                note: 'До побачення 👋'
            }
        },
        speaker: {
            ...
            speaker1: {
                ...
                bio: 'Віталій має багаторічний досвід у служінні та буде надавати духовну підтримку учасникам табору.',
                topic1: 'Духовна підтримка'
            },
            speaker2: {
                name: 'Давид Акопян',
                role: 'Служитель та наставник',
                bio: 'Давид має серце для молодих сімей та проводитиме тренінг з приготування проповіді.',
                topic1: 'Як приготувати проповідь'
            },
            speaker3: {
                name: 'В\'ячеслав Марфіч',
                role: 'Пастор та вчитель',
                bio: 'В\'ячеслав проведе бесіду на тему взаємодії віруючого з церквою.',
                topic: 'Я і церква'
            },
            additional: {
    ...
    ru: {
        ...
        program: {
            ...
            day1: {
                ...
                event1: '17:00 — Заезд и заселение',
                event2: '18:00 — Совместный ужин',
                event3: '19:00 — Программа лагеря, беседа, раскрытие темы',
                event4: '21:00 — Общение: чай, игры, викторины',
                note: 'Первый вечер 🤝'
            },
            day2: {
                title: 'Вторник, 10 февраля',
                event1: '08:00–09:00 — Завтрак',
                event2: '09:00–10:00 — Утреннее собрание',
                event3: '10:00–13:00 — Досуг',
                event4: '13:00–14:00 — Обед',
                event5: '14:00–18:00 — Досуг',
                event6: '18:00–19:00 — Ужин',
                event7: '19:00–20:00 — Общее собрание',
                event8: '21:00 — Общение, игры, викторины',
                note: 'Полный день ⛷️'
            },
            day3: {
            ...
            day4: {
                ...
                event1: '08:00–09:00 — Завтрак',
                event2: '09:00–11:00 — Утреннее собрание, итоги',
                event3: '11:00–12:30 — Сбор вещей',
                event4: '13:00–14:00 — Обед',
                event5: '14:00 — Выезд из лагеря',
                event6: 'После выезда — Катание на коньках 🛼',
                note: 'До свидания 👋'
            }
        },
        speaker: {
            ...
            speaker1: {
                ...
                bio: 'Виталий имеет многолетний опыт в служении и будет оказывать духовную поддержку участникам лагеря.',
                topic1: 'Духовная поддержка'
            },
            speaker2: {
                name: 'Давид Акопян',
                role: 'Служитель и наставник',
                bio: 'Давид имеет сердце для молодых семей и проведёт тренинг по подготовке проповеди.',
                topic1: 'Как подготовить проповедь'
            },
            speaker3: {
                name: 'Вячеслав Марфич',
                role: 'Пастор и учитель',
                bio: 'Вячеслав проведёт беседу на тему взаимодействия верующего с церковью.',
                topic: 'Я и церковь'
            },
            additional: {

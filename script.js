    ...
    ua: {
        ...
        speaker: {
            ...
            speaker1: {
                ...
                bio: 'Віталій має багаторічний досвід у служінні. Він проводитиме тренінги по фінансовій грамотності з християнської перспективи.',
                topic1: 'Фінансова грамотність',
                topic2: 'Приготування проповіді'
            },
            speaker2: {
                name: 'Давид Акопян',
                role: 'Служитель та наставник',
                bio: 'Давид має серце для молодих сімей та допомагає парам будувати міцні стосунки на біблійному фундаменті.',
                topic: 'Сімейні стосунки'
            },
            speaker3: {
                name: 'В\'ячеслав Марфіч',
                role: 'Пастор та вчитель',
                bio: 'В\'ячеслав навчатиме практичним навичкам приготування біблійних проповідей та ефективному служінню словом.',
                topic: 'Приготування проповіді'
            }
        },
        gallery: {
        ...
        register: {
            ...
            deadline: 'Реєстрація відкрита до 20 січня 2026',
            success: {
    ...
    ru: {
        ...
        speaker: {
            ...
            speaker1: {
                ...
                bio: 'Виталий имеет многолетний опыт в служении. Он будет проводить тренинги по финансовой грамотности с христианской перспективы.',
                topic1: 'Финансовая грамотность',
                topic2: 'Подготовка проповеди'
            },
            speaker2: {
                name: 'Давид Акопян',
                role: 'Служитель и наставник',
                bio: 'Давид имеет сердце для молодых семей и помогает парам строить крепкие отношения на библейском фундаменте.',
                topic: 'Семейные отношения'
            },
            speaker3: {
                name: 'Вячеслав Марфич',
                role: 'Пастор и учитель',
                bio: 'Вячеслав научит практическим навыкам подготовки библейских проповедей и эффективному служению словом.',
                topic: 'Подготовка проповеди'
            }
        },
        gallery: {
